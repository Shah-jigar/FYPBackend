...
if __name__ == "__main__":
    ...
    songs1 = ['Udd Jaa Kaale Kaava (From "Gadar 2")', 'Leke Prabhu Ka Naam (From "Tiger 3")',  'Phir Aur Kya Chahiye (From "Zara Hatke Zara Bachke")', 'Tum Kya Mile (From "Rocky Aur Rani Kii Prem Kahaani")']
    artists = ['Sukhbir', 'Aur', 'Neeti Mohan']
    print("Songs count: " + str(len(songs1)))
