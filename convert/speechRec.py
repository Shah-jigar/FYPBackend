...
def transcribe_large_audio(path):
    ...
    chunks = split_on_silence(
        sound, min_silence_len=800, silence_thresh=sound.dBFS-10, keep_silence=700)
...
result = transcribe_large_audio('output_audio.wav')

print(result)
# print(result, file=open('result.txt', 'w'))

# s = """ffmpeg -i 'C:/Projects/python/FYPBackend/downloads/genre/Garhwali/Anil - Chakdait Chhora.opus' -af afftdn=nr=30 output_audio.opus"""
